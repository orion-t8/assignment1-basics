...
from cs336_basics.model import TransformerLMWithoutLayerNorm
...
def training_loop(cfg: DictConfig) -> None:
    ...
    transformer_lm = TransformerLMWithoutLayerNorm(cfg.model.num_layers, cfg.model.vocab_size, cfg.model.d_model, cfg.model.num_heads,
